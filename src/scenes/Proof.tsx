...
export const Proof: React.FC = () => {
   ...
   *   Cat 1 AI Video:   40 – 121  VO ~33.3s (33:10) → video 33.3s
   *   Cat 2 Health:    121 – 225  VO ~39.5s → video 39.5s
   *   Cat 3 Financial: 228 – 300  VO ~39.8–42s → video 39.8–42s
   *   Phase 2 Real:    298 – 375  VO ~42s–44.5s → video 44.5s (44:15)
   *   Phase 3 Weeks:   375 – 478  VO ~44.5s (44:15) → video 44.5s
   */
  const cat1 = interpolate(frame, [40, 55, 101, 121], [0, 1, 1, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  ...
  const phase2 = interpolate(frame, [298, 312, 365, 375], [0, 1, 1, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const phase3 = interpolate(frame, [375, 390, 468, 478], [0, 1, 1, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 50 }}>
          ...
          <div style={{
            ...
            opacity: interpolate(frame, [410, 425], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }),
          }}>
            ...
            <div style={{ position: "relative", width: 130, height: 130 }}>
              ...
              <svg width="130" height="130" viewBox="0 0 130 130" style={{ position: "absolute", top: 0, left: 0 }}>
                <line x1="10" y1="10" x2="120" y2="120" stroke={theme.colors.accent} strokeWidth="3" opacity="0.7"
                  strokeDashoffset={interpolate(frame, [430, 450], [155, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" })} />
                <line x1="120" y1="10" x2="10" y2="120" stroke={theme.colors.accent} strokeWidth="3" opacity="0.7"
                  strokeDasharray="155" strokeDashoffset={interpolate(frame, [435, 455], [155, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" })} />
              </svg>
            </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
            {[0, 1, 2].map(a => {
              const arrowP = interpolate(frame, [440 + a * 6, 453 + a * 6], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: Easing.bezier(0.19, 1, 0.22, 1) });
              return (
          ...
          <div style={{
            display: "flex", flexDirection: "column", alignItems: "center", gap: 14,
            opacity: interpolate(frame, [445, 460], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }),
          }}>
            ...
            <div style={{ position: "relative" }}>
              <svg width="130" height="130" viewBox="0 0 130 130">
                ...
                {Array.from({ length: 10 }).map((_, d) => {
                  const dayP = interpolate(frame - 450, [d * 2, d * 2 + 8], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
                ...
                <path d="M80 88 L90 98 L110 75" fill="none" stroke={theme.colors.green} strokeWidth="3" strokeLinecap="round"
                  opacity={interpolate(frame, [465, 475], [0, 0.8], { extrapolateLeft: "clamp", extrapolateRight: "clamp" })} />
              </svg>
              {/* Rocket */}
              <svg width="40" height="50" viewBox="0 0 40 50" style={{
                position: "absolute", top: -20, right: -15,
                transform: `rotate(-30deg) translateY(${-breatheY * 2}px)`,
                opacity: interpolate(frame, [455, 465], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }),
              }}>
